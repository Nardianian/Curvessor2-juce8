                                         ...
                                         BinaryData::background_pngSize))
{
  ...
  this->stereoLinkLabel.setFont(Font(20._p, Font::bold));
  ...
  this->stereoLinkLabel.setJustificationType(Justification::centred);
  ...
  this->stereoLink.getControl().setTextValueSuffix("%");
...
CurvessorAudioProcessorEditor::resized()
{
  ...
  grid.items = {
    ...
    GridItem(midSide.getControl())
      ...
      .withAlignSelf(GridItem::AlignSelf::center)
      .withJustifySelf(GridItem::JustifySelf::center),
    GridItem(this->stereoLinkLabel)
      .withAlignSelf(GridItem::AlignSelf::start)
      .withJustifySelf(GridItem::JustifySelf::center),
    GridItem(this->stereoLink.getControl())
      .withWidth(135._p)
      .withAlignSelf(GridItem::AlignSelf::center)
      .withJustifySelf(GridItem::JustifySelf::center),
